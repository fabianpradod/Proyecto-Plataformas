...
private val noticias = listOf(
    ...
    Noticia(type = CategoryType.Instrumentos, id = 1, name = "Instrument 1", smallText = "Brief description of Instrument 1", actualText = "Detailed information about Instrument 1", image = "marimba1"),
    Noticia(type = CategoryType.Instrumentos, id = 2, name = "Instrument 2", smallText = "Brief description of Instrument 2", actualText = "Detailed information about Instrument 2", image = "marimba1"),
    Noticia(type = CategoryType.Instrumentos, id = 3, name = "Instrument 3", smallText = "Brief description of Instrument 3", actualText = "Detailed information about Instrument 3", image = "marimba1"),
    Noticia(type = CategoryType.Instrumentos, id = 4, name = "Instrument 4", smallText = "Brief description of Instrument 4", actualText = "Detailed information about Instrument 4", image = "marimba1")
